...
namespace Core
{
	using BuildConfigFlags   = Utils::Flags<std::uint16_t>;
	using BuildSystemFlags   = Utils::Flags<std::uint16_t>;
	using BuildToolsetFlags  = Utils::Flags<std::uint16_t>;
	using BuildPlatformFlags = Utils::Flags<std::uint16_t>;
